            ...
            <div className="cart-build-summary-grid">
              {buildGroups.map((bundle) => (
                <div key={bundle.pc_build_id} className="cart-build-summary-card">
                  ...
                  <div className="cart-build-subtotal">PKR {bundle.subtotal.toLocaleString('en-US')}</div>
                </div>
              ))}
            </div>
          ...
          <>
            {vendorGroups.map((group) => (
              <div key={String(group.vendor_id || 0)} className="cart-table" style={{ marginBottom: 20 }}>
                <div className="cart-row" style={{ background: '#f8f9fb' }}>
                  ...
                  <div className="cart-cell cart-subtotal"><strong>PKR {Number(group.subtotal || 0).toLocaleString('en-US')}</strong></div>
                ...
                {group.items.map((item) => (
                  <div className="cart-row" key={item.cart_item_id}>
                    ...
                    <div className="cart-cell cart-price">PKR {Number(item.price || 0).toLocaleString('en-US')}</div>
            ...
            <div className="cart-total-summary">
              <div className="cart-total-row">
                ...
                <span className="cart-total-amount">PKR {cartTotal.toLocaleString('en-US')}</span>
              </div>
              {blockingOrder ? (
