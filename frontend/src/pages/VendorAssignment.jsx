      ...
      <div className="container">
        <div className="page-header vendor-page-header">
          ...
          <p className="vendor-page-lede">
            Pick who builds or ships your PC, review totals, then pay — you’re almost done.
          </p>
        </div>
          ...
          <div className="payment-panel">
            ...
            <div className="order-summary">
              ...
              <div className="summary-item">
                ...
                <span>PKR {assemblyFee.toLocaleString()}</span>
              </div>
              <div className="summary-item">
                <span>Shipping</span>
            ...
            <div className="payment-method">
              ...
              <p className="payment-method-hint" id="payment-method-desc">
                Choose how you’ll pay. Card details appear only for online payment.
              </p>
              <div className="payment-method-options" role="radiogroup" aria-labelledby="payment-method-heading">
                <label className="option-toggle">
                  <input
                    type="radio"
                    name="payment"
            ...
            {paymentMethod === 'online' ? (
              ...
              >
                <h3 id="payment-card-heading">Card details</h3>
                <label className="payment-field-label" htmlFor="pay-card-number">Card number</label>
                <input
                  id="pay-card-number"
                  type="text"
                  className="input"
                ...
                <div className="form-row">
                  <div className="payment-field-group">
                    <label className="payment-field-label" htmlFor="pay-card-exp">Expiry</label>
                    <input
                      id="pay-card-exp"
                      type="text"
                      className="input"
                  ...
                  <div className="payment-field-group">
                    <label className="payment-field-label" htmlFor="pay-card-cvv">CVV</label>
                    <input
                      id="pay-card-cvv"
                      type="text"
                      className="input"
                ...
                <label className="payment-field-label" htmlFor="pay-card-name">Cardholder name</label>
                <input
                  id="pay-card-name"
                  type="text"
                  className="input"
            ...
            >
              {placing ? 'Confirming...' : 'Confirm & continue to payment'}
            </button>
            {confirmError ? (
