...
function publishableKeyHint() {
  ...
  return 'not set — add VITE_STRIPE_PUBLISHABLE_KEY=pk_test_... to my-react-app/.env.local, save (Ctrl+S), then restart npm run dev';
}
  ...
  return (
    <div className="stripe-verify-page container">
      ...
      <p className="stripe-verify-muted">
        Keys stay on your machine only (<code>backend/.env</code> + <code>my-react-app/.env.local</code>).
