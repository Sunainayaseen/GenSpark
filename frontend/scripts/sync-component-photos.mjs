/**
 * Copy images/Components → public/component-photos (slug filenames).
 * Run from repo root: node my-react-app/scripts/sync-component-photos.mjs
 */
import fs from 'fs';
...
const srcDir = path.join(repoRoot, 'images', 'Components');
