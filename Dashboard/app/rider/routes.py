...
def request_pickup(delivery_id):
    ...
    # Notify admins — pickup needs their approval before the rider can start transit.
    try:
        from app.services.notification_service import notify_admin_rider_pickup_request
        notify_admin_rider_pickup_request(job)
    except Exception as _e:
        print('notify admin rider-pickup skipped:', _e)
