"""
Train YOLOv8 on dataset/data.yaml and deploy weights to backend/models/best.pt.
...
def main() -> None:
    ...
    parser.add_argument("--no-deploy", action="store_true", help="Skip copy to backend/models")
